...
# variables to example_interfaces_DEFINITIONS, example_interfaces_INCLUDE_DIRS,
# example_interfaces_LIBRARIES, and example_interfaces_LINK_FLAGS.
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(example_interfaces_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      ...
      if(${_dep}_LINK_FLAGS)
        list_append_unique(example_interfaces_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
