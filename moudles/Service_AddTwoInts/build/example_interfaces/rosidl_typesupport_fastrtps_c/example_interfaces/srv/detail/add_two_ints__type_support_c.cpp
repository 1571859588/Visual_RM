...
#include "example_interfaces/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddTwoInts_Request__ros_msg_type = example_interfaces__srv__AddTwoInts_Request;
...
static size_t _AddTwoInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__srv__AddTwoInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, AddTwoInts_Request)() {
...
using _AddTwoInts_Response__ros_msg_type = example_interfaces__srv__AddTwoInts_Response;
...
static size_t _AddTwoInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__srv__AddTwoInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, AddTwoInts_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, AddTwoInts)() {
