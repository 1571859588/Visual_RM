...
if(_lt_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED lt_FOUND)
...
set(_lt_CONFIG_INCLUDED TRUE)

# output package information
if(NOT lt_FIND_QUIETLY)
  message(STATUS "Found lt: 0.0.0 (${lt_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'lt' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${lt_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(lt_FOUND_AMENT_PACKAGE TRUE)
