...
#include "learning_interfence/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_learning_interfence
cdr_serialize(
  const learning_interfence::srv::AddTwoInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  learning_interfence::srv::AddTwoInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
...
{
  auto typed_message =
    static_cast<const learning_interfence::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<learning_interfence::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_learning_interfence
const rosidl_message_type_support_t *
get_message_type_support_handle<learning_interfence::srv::AddTwoInts_Request>()
{
  return &learning_interfence::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learning_interfence, srv, AddTwoInts_Request)() {
  return &learning_interfence::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_learning_interfence
cdr_serialize(
  const learning_interfence::srv::AddTwoInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  learning_interfence::srv::AddTwoInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
...
{
  auto typed_message =
    static_cast<const learning_interfence::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<learning_interfence::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &learning_interfence::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learning_interfence, srv, AddTwoInts_Response)() {
  return &learning_interfence::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &learning_interfence::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learning_interfence, srv, AddTwoInts)() {
  return &learning_interfence::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
