...
class Metaclass_AddTwoInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('learning_interfence')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'learning_interfence.srv.AddTwoInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from learning_interfence.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from learning_interfence.srv._add_two_ints import AddTwoInts_Request as Request
    from learning_interfence.srv._add_two_ints import AddTwoInts_Response as Response
