...
#include "learning_interface/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const learning_interface::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<learning_interface::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &learning_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const learning_interface::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<learning_interface::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &learning_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &learning_interface::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
